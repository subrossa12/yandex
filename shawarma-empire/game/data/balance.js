...
(function (root) {
  ...
  var BALANCE = {
    ...
    /*
     * Межстраничной рекламы в игре нет и настраивать здесь нечего.
     * Она была — при продаже сети и при открытии точки, — но по п. 4.4
     * в играх реального времени показ по игровому действию запрещён,
     * а «Шаурма Империя» именно такая: точки работают непрерывно.
     * Блок убран целиком, чтобы флагом её нельзя было включить обратно.
     */
